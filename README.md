...
- Sobre o projeto
Projeto para ajudar a organizar sua dieta e criar planos de treino personalizados. Com uma dashboard intuitiva, você poderá acompanhar o progresso dos seus treinos, monitorar seu consumo de água e ajustar seus exercícios conforme necessário. A plataforma permite criar treinos distintos para diferentes horários, tornando mais fácil adaptar a rotina às suas necessidades diárias.

- Tecnologias
Este projeto foi desenvolvido para testar o HonoJs em conjunto com o Drizzle ORM. Utilizamos NextJs com TypeScript, TailwindCSS e Bun. Para projetos pequenos e médios, o HonoJs se mostra bastante eficiente e otimizado, especialmente em um ambiente monorepo. No entanto, para projetos maiores, pode não ser a solução mais viável a longo prazo em termos de manutenção.
# Dependências usadas

# Projeto hospedado
- [Vercel](https://fittrackpro.vercel.app/)

 - [`@alptugidin/react-circular-progress-bar`](https://www.npmjs.com/package/@alptugidin/react-circular-progress-bar) - ^1.1.2
- [`@clerk/backend`](https://www.npmjs.com/package/@clerk/backend) - ^1.2.2
- [`@clerk/nextjs`](https://www.npmjs.com/package/@clerk/nextjs) - ^5.2.2
- [`@hono/clerk-auth`](https://www.npmjs.com/package/@hono/clerk-auth) - ^2.0.0
- [`@hono/zod-validator`](https://www.npmjs.com/package/@hono/zod-validator) - ^0.2.2
- [`@hookform/resolvers`](https://www.npmjs.com/package/@hookform/resolvers) - ^3.9.0
- [`@neondatabase/serverless`](https://www.npmjs.com/package/@neondatabase/serverless) - 0.9.1
- [`@paralleldrive/cuid2`](https://www.npmjs.com/package/@paralleldrive/cuid2) - ^2.2.2
- [`@radix-ui/react-accordion`](https://www.npmjs.com/package/@radix-ui/react-accordion) - ^1.2.0
- [`@radix-ui/react-alert-dialog`](https://www.npmjs.com/package/@radix-ui/react-alert-dialog) - ^1.1.1
- [`@radix-ui/react-aspect-ratio`](https://www.npmjs.com/package/@radix-ui/react-aspect-ratio) - ^1.1.0
- [`@radix-ui/react-avatar`](https://www.npmjs.com/package/@radix-ui/react-avatar) - ^1.1.0
- [`@radix-ui/react-checkbox`](https://www.npmjs.com/package/@radix-ui/react-checkbox) - ^1.1.1
- [`@radix-ui/react-collapsible`](https://www.npmjs.com/package/@radix-ui/react-collapsible) - ^1.1.0
- [`@radix-ui/react-context-menu`](https://www.npmjs.com/package/@radix-ui/react-context-menu) - ^2.2.1
...
- [`@radix-ui/react-hover-card`](https://www.npmjs.com/package/@radix-ui/react-hover-card) - ^1.1.1
...
- [`@radix-ui/react-menubar`](https://www.npmjs.com/package/@radix-ui/react-menubar) - ^1.1.1
- [`@radix-ui/react-navigation-menu`](https://www.npmjs.com/package/@radix-ui/react-navigation-menu) - ^1.2.0
- [`@radix-ui/react-popover`](https://www.npmjs.com/package/@radix-ui/react-popover) - ^1.1.1
- [`@radix-ui/react-progress`](https://www.npmjs.com/package/@radix-ui/react-progress) - ^1.1.0
- [`@radix-ui/react-radio-group`](https://www.npmjs.com/package/@radix-ui/react-radio-group) - ^1.2.0
- [`@radix-ui/react-scroll-area`](https://www.npmjs.com/package/@radix-ui/react-scroll-area) - ^1.1.0
- [`@radix-ui/react-select`](https://www.npmjs.com/package/@radix-ui/react-select) - ^2.1.1
- [`@radix-ui/react-separator`](https://www.npmjs.com/package/@radix-ui/react-separator) - ^1.1.0
- [`@radix-ui/react-slider`](https://www.npmjs.com/package/@radix-ui/react-slider) - ^1.2.0
- [`@radix-ui/react-slot`](https://www.npmjs.com/package/@radix-ui/react-slot) - ^1.1.0
- [`@radix-ui/react-switch`](https://www.npmjs.com/package/@radix-ui/react-switch) - ^1.1.0
- [`@radix-ui/react-tabs`](https://www.npmjs.com/package/@radix-ui/react-tabs) - ^1.1.0
- [`@radix-ui/react-toast`](https://www.npmjs.com/package/@radix-ui/react-toast) - ^1.2.1
- [`@radix-ui/react-toggle`](https://www.npmjs.com/package/@radix-ui/react-toggle) - ^1.1.0
